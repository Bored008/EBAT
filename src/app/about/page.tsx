          ...
          <div className="flex flex-col lg:flex-row items-center w-full gap-[20px]">
            ...
            <div className="flex flex-col flex-1 w-full p-[28px_20px] justify-between bg-white min-h-[349px]">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18.3333 31.1667L11 23.8334L13.585 21.2484L18.3333 25.9784L30.415 13.8967L33 16.5M22 1.83337L5.5 9.16671V20.1667C5.5 30.3417 12.54 39.8567 22 42.1667C31.46 39.8567 38.5 30.3417 38.5 20.1667V9.16671L22 1.83337Z" fill="white" />
              </svg>
              <div className="flex flex-col gap-[20px]">
                <h3 className="font-sans font-medium text-[24px] leading-[1.3] tracking-[-0.02em] text-black">Mission Reliability</h3>
            ...
            <div className="flex flex-col flex-1 w-full p-[28px_20px] justify-between bg-white min-h-[349px]">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="44" height="44" fill="#F00511" />
                <path d="M34.9615 9.0383C32.1068 6.18052 28.3882 4.34554 24.3834 3.81842C20.3786 3.2913 16.3118 4.10155 12.8148 6.1233M7.33316 11H7.3515M4.19816 17.6366C3.51083 20.4362 3.49339 23.3585 4.14724 26.1661C4.8011 28.9737 6.10782 31.5876 7.96133 33.7955C9.81483 36.0034 12.1629 37.743 14.8148 38.8733C17.4668 40.0035 20.3479 40.4925 23.2242 40.3004C26.1005 40.1083 28.8911 39.2407 31.3692 37.7679C33.8473 36.2951 35.9432 34.2587 37.4867 31.824C39.0302 29.3893 39.9779 26.6249 40.2526 23.7553C40.5274 20.8857 40.1216 17.9917 39.0682 15.3083" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M29.7734 14.2266C28.7183 13.1654 27.4578 12.3306 26.069 11.7734C24.6802 11.2161 23.1923 10.9481 21.6964 10.9856C20.2004 11.0232 18.7279 11.3657 17.3688 11.992C16.0097 12.6183 14.7928 13.5153 13.7923 14.6281C12.7919 15.741 12.029 17.0462 11.5504 18.4641C11.0718 19.8819 10.8875 21.3825 11.0089 22.874C11.1302 24.3655 11.5546 25.8166 12.256 27.1384C12.9575 28.4602 13.9212 29.6251 15.0884 30.5616M22 32.9999H22.0184M32.9817 21.3766C33.0814 23.1208 32.7643 24.8636 32.0565 26.4609C31.3488 28.0581 30.2707 29.4638 28.9117 30.5616" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M21.9997 25.6666C24.0247 25.6666 25.6663 24.025 25.6663 21.9999C25.6663 19.9749 24.0247 18.3333 21.9997 18.3333C19.9746 18.3333 18.333 19.9749 18.333 21.9999C18.333 24.025 19.9746 25.6666 21.9997 25.6666Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M24.585 19.415L34.9616 9.03833" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <div className="flex flex-col gap-[20px]">
                <h3 className="font-sans font-medium text-[24px] leading-[1.3] tracking-[-0.02em] text-black">Real-Time Intelligence</h3>
                <p className="font-sans font-normal text-[16px] leading-[1.5] tracking-[-0.02em] text-black/75">
