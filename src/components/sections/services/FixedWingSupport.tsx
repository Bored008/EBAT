...
export function FixedWingSupport() {
  ...
  const cardIds = ['repair', 'maintenance', 'parts'];
  const handlePrev = () => {
    ...
    <div className="flex flex-col gap-[36px] w-full overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
        ...
        <motion.div 
          ...
          className="flex flex-col gap-[12px] max-w-[404px]"
        >
          ...
          <div className="flex items-center gap-[12px]">
            <button 
              ...
              className="w-[44px] h-[44px] rounded-full bg-[#F00511] flex items-center justify-center cursor-pointer transition-transform hover:scale-105 active:scale-95"
            >
            ...
            <button 
              ...
              className="w-[44px] h-[44px] rounded-full border border-[#F00511] flex items-center justify-center cursor-pointer transition-transform hover:scale-105 active:scale-95"
            >
      ...
      {/* Interactive 3-Card Deck with Smooth Crossfade & Staggered Scroll Entrance */}
