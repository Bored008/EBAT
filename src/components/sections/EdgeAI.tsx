...
export function EdgeAI() {
  return (
    <section className="w-full max-w-[1260px] mx-auto px-6 py-24 flex flex-col gap-[36px]">
      {/* Header Info Container */}
      <div className="flex flex-col gap-2 max-w-[816px]">
        <h2 className="font-heading font-bold text-[48px] md:text-[64px] leading-tight tracking-[-0.05em] text-white">
          What is <span className="font-accent italic font-normal text-[#F00511] underline">Edge AI</span>
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 auto-rows-[340px] gap-4 w-full h-auto lg:h-[695px] relative">
        ...
        <div className="relative group overflow-hidden rounded-[12px] border-[0.5px] border-white/50 lg:col-span-2 lg:row-span-1 z-10 flex flex-col justify-end p-6 md:p-8">
          <Image
          ...
          <h3 className="font-sans font-semibold text-[32px] md:text-[40px] leading-[1.1] tracking-[-0.05em] text-white mb-3">
            <span className="text-[#F00511]">Intelligence</span><br />
            at the Edge
          </h3>
          <p className="font-sans text-[14px] md:text-[16px] text-white/75 leading-snug tracking-[-0.02em] max-w-[777px]">
        ...
        <div className="relative group overflow-hidden rounded-[12px] border-[0.5px] border-white/50 lg:col-span-1 lg:row-span-2 z-10 flex flex-col justify-end p-6 md:p-8">
          <Image
          ...
          <div className="flex flex-col gap-2">
            <h3 className="font-sans font-semibold text-[32px] md:text-[40px] leading-[1.1] tracking-[-0.05em] text-white">
              <span className="text-[#F00511]">Secure</span><br className="hidden lg:block"/> On-Device Processing
            </h3>
            <p className="font-sans text-[14px] md:text-[16px] text-white/75 leading-snug tracking-[-0.02em]">
        ...
        <div className="relative group overflow-hidden rounded-[12px] border-[0.5px] border-white/50 lg:col-span-1 lg:row-span-1 z-10 flex flex-col justify-end p-6 md:p-8">
          <Image
          ...
          <div className="flex flex-col gap-2">
            <h3 className="font-sans font-semibold text-[32px] md:text-[40px] leading-[1.1] tracking-[-0.05em] text-white">
              <span className="text-[#F00511]">Real-Time</span><br />
              Detection
            </h3>
            <p className="font-sans text-[14px] text-white/75 leading-snug tracking-[-0.02em]">
        ...
        <div className="relative group overflow-hidden rounded-[12px] border-[0.5px] border-white/50 lg:col-span-1 lg:row-span-1 z-10 flex flex-col justify-end p-6 md:p-8">
          ...
          <div className="flex flex-col gap-2">
            <h3 className="font-sans font-semibold text-[32px] md:text-[40px] leading-[1.1] tracking-[-0.05em] text-white">
              Offline <span className="text-white">Operation</span>
            </h3>
            <p className="font-sans text-[14px] text-white/75 leading-snug tracking-[-0.02em]">
              Identify people, vehicles, objects, and anomalies instantly with AI models optimized for rapid, low-latency analysis and immediate operational response.
            </p>
